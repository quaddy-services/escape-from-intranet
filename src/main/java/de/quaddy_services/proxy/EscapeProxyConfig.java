...
public class EscapeProxyConfig implements Serializable {
	 ...
	 * 
	 */
	public ProxyDecision getProxyDecision() {
		String tempProperty = properties.getProperty("DefaultProxyDecision", ProxyDecision.DIRECT_PREFERRED.name());
		try {
			return ProxyDecision.valueOf(tempProperty);
		} catch (IllegalArgumentException e) {
			LOGGER.info("Ignore " + tempProperty, e);
			return null;
		}
	}
	 ...
	 * 
	 */
	public void setDefaultProxyDecision(ProxyDecision aPreferred) {
		properties.setProperty("DefaultProxyDecision", aPreferred.name());
	}
}
